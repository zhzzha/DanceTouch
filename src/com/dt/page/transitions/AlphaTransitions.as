package com.dt.page.transitions
{
	...
	public class AlphaTransitions extends EventDispatcher implements ITransitions
	{
		...
		public function AlphaTransitions(container:Container)
		{
		...
		public function start(original:DefaultPage, objective:DefaultPage):void
		{
			...
			TweenLite.to(_objective,1,{alpha:1,onComplete:onComplete});
		}
